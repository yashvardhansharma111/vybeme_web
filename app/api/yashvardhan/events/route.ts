...
/**
 * GET /api/yashvardhan/events
 * No auth required from client. Returns list of events (business plans) for the /yashvardhan page.
 * Uses server-side YASHVARDHAN_ACCESS_TOKEN and YASHVARDHAN_USER_ID.
 */
export async function GET() {
  ...
  try {
    ...
    console.error('[yashvardhan events]', e);
