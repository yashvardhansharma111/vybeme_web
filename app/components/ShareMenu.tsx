    ...
    <div className={`relative inline-block ${className ?? ''}`}>
      {children ? (
        ...
        <button
          type="button"
          onClick={handleShare}
          className="inline-flex items-center justify-center gap-1.5 rounded-full border border-neutral-200 bg-white px-3 py-1.5 text-xs font-medium text-neutral-700 hover:bg-neutral-50 md:px-4 md:py-2 md:text-sm"
          aria-label="Share"
        >
          Share
